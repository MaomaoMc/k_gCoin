        ...
        return <div>
                     ...
                     data.length > 0 && data.map(function (item, i) {
                        return <div key={i} className="item">
                            ...
                            <div className="goodItem f_rt">
                                <h6 className="fz_30 fc_white">{item.name}</h6>
                                <div>
            ...
            <div className={this.state.dlgShow ? "dialog dlgPayKj" : "dialog dlgPayKj hide"}>
                ...
                <div className="dlg_form">
                    <input className="b_blue1 fc_white" type="password" placeholder = "请输入交易密码" 
                    value = {this.state.tradePassPwd} 
                    onChange = {e => {
                        this.handlePwdEvent({val: e.target.value})
                    }}
                    />
                     <div className="fgtTradepass"><Link to = "/account/forgetTradePwd">
                        <span className="fz_24 fc_brown">忘记交易密码?</span></Link></div>
